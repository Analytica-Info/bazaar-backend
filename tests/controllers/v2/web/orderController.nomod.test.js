...
describe('checkoutNomod', () => {
    it('200 — returns checkoutId, checkoutUrl, status in envelope', async () => {
        ...
        const { statusCode, body } = await runHandler(ctrl.checkoutNomod, req, { path: '/v2/test' });
...
describe('verifyNomod', () => {
    it('200 — returns orderId in envelope', async () => {
        ...
        const { statusCode, body } = await runHandler(ctrl.verifyNomod, req, { path: '/v2/test' });
