...
- `docs/archive/2026-q2-v2-migration/LOGIN-AUDIT.md` — 2026-05 inventory of all 27 v1 login flows (archived; superseded by `docs/v2-auth/`)
- `docs/archive/2026-q2-v2-migration/CRITICAL-FLOWS-AUDIT.md` — 2026-05 cart/checkout/payment shape parity snapshot (archived)
