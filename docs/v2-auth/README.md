...
- [`docs/archive/2026-q2-v2-migration/LOGIN-AUDIT.md`](../archive/2026-q2-v2-migration/LOGIN-AUDIT.md) — historical v1 login-surface findings that motivated v2 (archived).
...
- **Live API docs**: `GET /v2/docs` (Swagger UI) and `GET /v2/openapi.json` (raw spec) — v2 routes mount unconditionally; just `npm start` and visit [http://localhost:5000/v2/docs](http://localhost:5000/v2/docs).
