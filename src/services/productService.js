...
exports.getHomeProducts = async () => {
  return cache.getOrSet(
    ...
    async () => {
      try {
        logger.info("API - Fetch Home Products (Cache Miss)");
        ...
        logger.info("Return - API - Fetch Home Products (Repopulated)");
        return { result };
      } catch (error) {
        logger.error({ err: error }, "Error in getHomeProducts cache re-population");
