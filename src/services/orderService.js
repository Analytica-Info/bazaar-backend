...
exports.updateAddress                  = order.updateAddress;
exports.setPrimaryAddress              = order.setPrimaryAddress;   // legacy alias — prefer updateAddress({primary:true})
...
exports.createTabbySession             = order.createTabbySession;
...
exports.handleStripeWebhook            = order.handleStripeWebhook;
