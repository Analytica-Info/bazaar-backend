...
const NotifyMeSubscriptionRepository = require('./NotifyMeSubscriptionRepository');
const VerticalRepository = require('./VerticalRepository');
const PaymentMethodConfigRepository = require('./PaymentMethodConfigRepository');
...
const repos = {
    ...
    notifyMeSubscriptions: new NotifyMeSubscriptionRepository(),
