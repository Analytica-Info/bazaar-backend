...
const EXCEPTIONS = [
  ...
  {
    file: 'src/services/payments/NomodProvider.js',
    limit: 400,
    reason: 'wave 4: payment provider implementing 7 SOLID methods (createCheckout, getCheckout, refundCharge, refund, cancelCheckout, queryPaymentState, handleWebhook) plus 429 retry helpers; splitting fragments cohesion since all methods share the same axios client + retry behavior',
  },
  {
